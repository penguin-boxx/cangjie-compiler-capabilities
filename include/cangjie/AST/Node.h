...
enum class AnnotationKind {
    ...
    INTRINSIC,
    WHEN,
    /** Checked exceptions (experimental): '@AssumeThrows[E1, E2]' on an import (proposal 5.2.2). */
    ASSUME_THROWS,
    FASTNATIVE,
...
struct Annotation : public Node {
    ...
    /**
     * For '@AssumeThrows' on an import (proposal 5.2.2): the exception types imposed as a
...
struct ThrowsClause : Node {
    ...
    /**
     * The `...` marker of a declaration clause (proposal 6.3.5): the listed entries are declared
...
struct FuncType : Type {
    ...
    Position rightParenPos;                 /**< Position of ')'. */
    /**< Effect `performs` clause (experimental, proposal 8.2). Precedes 'throws'. Optional. */
