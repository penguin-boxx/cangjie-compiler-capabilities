...
private:
    ...
    void WalkScoped(Ptr<Node> root)
    {
        ...
        Walker(root, [this](Ptr<Node> node) { return VisitPre(node); },
...
void ReportCapabilityMissHandler::HandleMiss(const CapabilityDemand& demand)
{
    ...
    auto kind =
        asWarning ? DiagKindRefactor::sema_chexc_missing_capability_warn : DiagKindRefactor::sema_chexc_missing_capability;
